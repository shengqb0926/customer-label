...
import { AssociationConfig, AssociationAlgorithm } from '../entities/association-config.entity';
...
describe('AssociationManagerService', () => {
  ...
  const mockAssociationConfig: Partial<AssociationConfig> = {
    ...
    configName: '测试配置',
    description: '测试描述',
    algorithm: AssociationAlgorithm.APRIORI,
    parameters: { minSupport: 0.5, minConfidence: 0.7 },
    isActive: true,
    runCount: 0,
    createdAt: new Date(),
    updatedAt: new Date(),
